    ...
    <div className="md:flex md:justify-center md:items-center md:h-screen">
      <div className="flex md:flex-row flex-col md:w-[600px] w-auto bg-neutral-white rounded-lg md:h-[450px] h-[540px] ">
        ...
        <div className="flex flex-col md:flex-1 ">
          ...
          <span className="font-montserrat tracking-[7px] mt-7 mb-4 text-left md:text-[14px] text-[10px] text-neutral-darkGrayishblue ml-5 md:ml-0">
            PERFUME
          </span>
          <div className="md:mb-5 mb-3 font-fraunces md:text-[37px] text-left md:leading-[2.4rem] leading-[1.4rem] text-neutral-veryDarkBlue text-[25px] ml-5 md:ml-0">
            <span>
              Gabrielle Essence <br className="md:hidden" /> Eau{" "}
              <br className="hidden md:block" /> De Parfum
            </span>
          </div>
          <div className="font-montserrat  text-left mb-6 md:text-[14px] text-[12px] leading-[1.4rem] ml-5 md:ml-0">
          ...
          <div className="flex space-x-5 justify-start items-center ml-5 md:ml-0">
          ...
          <button className="bg-primary-darkCyan text-neutral-white p-2 md:mr-10 ml-5 w-auto mr-5  md:ml-0 md:w-52 rounded-lg md:mt-5 mt-3 flex items-center gap-x-2 justify-center">
            <span>
